/*
  FuncJS by Sharikul Islam Version 2. This release: January 2013.
  You may modify this file but in a way which benefits everyone.
  Last version of FuncJS had 23 functions. This new release
  has 14 functions. 
*/
...
store = function(t, m, k, v) {
  ...
  if (!(t === void 0 || m === void 0 || k === void 0 || t === null || m === null || k === null || t === "" || m === "" || k === "")) {
    ...
    if (type === "session") {
      if (method === "set") {
        if (key !== null && value !== null || key !== "" && key !== "") {
    ...
    if (typeof e === "string") {
      ...
      if (return_val.length === 1) {
        ...
        if (_tag.length === 1 || _tag.length > 1 && _name.length === 1 || _name.length > 1) {
          ...
          if (_tag.length === 1 || _tag.length > 1 && _name.length === 0) {
            if (_tag.length === 1) {
              return _tag[0];
            } else {
              return _tag;
